...
public class RegisterPage extends Util {
    ...
    public void birthDayField(String birthDay) {
        ...
        selectByValueFromDropDown(_birthDayField, birthDay);
    }

    public void birthMonthField(String birthMonth) {

        selectByValueFromDropDown(_birthMonthField, birthMonth);
    }

    public void birthYearField(String birthYear) {

        selectByValueFromDropDown(_birthYearField, birthYear);
    }

    public void emailField() {
        String email = "vijay"+ generateRandomNumber() + "@gmail.com";
